...
public class AdminMenu {
    ...
    private static GameCh getChar() {
        System.out.println("Enter char: ");
        String str = sc.nextLine();
        if (str.equals("1")) return GameCh.CHARACTER1;
        else if (str.equals("2")) return GameCh.CHARACTER2;
        else if (str.equals("3")) return GameCh.CHARACTER3;
        else if (str.equals("4")) return GameCh.CHARACTER4;
        else {
