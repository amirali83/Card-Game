...
public class securityQuestionMenuGraphic extends Application {
    String ans;
    public securityQuestionMenuGraphic() {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Pane pane = fxmlLoader.load(getClass().getResource("/FXML/securityQuestionMenu.fxml"));
