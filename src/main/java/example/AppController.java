...
//            ProfileMenu(sc);
    ...
    private static void buildEspecialCards() {
        ...
        AppData.allCards.add(new EspecialCard ("changer", "it will get two random cards from opponent and reduce ones damage and anothers power (no space will be taken)", 100, 0, "/CardImage/hole changer.png"));
